...
namespace MyMLApp
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Randika\Playground\Toutorials\ML.NET\sentiment labelled sentences\sentiment labelled sentences\amazon_cells_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.Regression.Trainers.FastForest(new FastForestRegressionTrainer.Options(){NumberOfTrees=2505,NumberOfLeaves=320,FeatureFraction=0.8078704F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}));
